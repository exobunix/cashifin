  ...
  return (
    <div className="p-6 md:p-8 space-y-6 relative">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {jobs.map((job) => (
          <div key={job.id} className="bg-white p-5 rounded-2xl border border-slate-200/80 shadow-3xs flex flex-col justify-between h-48">
            <div className="space-y-2">
              ...
              <h4 className="font-extrabold text-sm text-slate-800">{job.name}</h4>
            ...
            <div className="flex gap-2 pt-4">
              <Link 
                ...
                className="flex-1 text-center py-2.5 bg-[#39b54a] hover:bg-[#2fa03e] text-white rounded-xl text-[10px] font-black shadow-3xs transition cursor-pointer"
              >
                Start Inspection
              </Link>
              <button 
